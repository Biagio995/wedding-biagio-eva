 ...
 */
$rows = [
    ['Add an email address before sending the invitation.', 'Aggiungi un indirizzo email prima di inviare l’invito.', 'Προσθέστε email πριν στείλετε την πρόσκληση.', 'Bitte zuerst eine E-Mail-Adresse hinzufügen, bevor die Einladung gesendet wird.'],
    ...
    ['Choose a valid email language.', 'Scegli una lingua email valida.', 'Επιλέξτε έγκυρη γλώσσα email.', 'Bitte eine gültige E-Mail-Sprache wählen.'],
    ...
    ['Default (:lang)', 'Predefinita (:lang)', 'Προεπιλογή (:lang)', 'Standard (:lang)'],
    ...
    ['Email language', 'Lingua email', 'Γλώσσα email', 'E-Mail-Sprache'],
    ...
    ['First row must be the header. Columns: name (required), email, locale and token (optional). Use comma or semicolon as separator.', 'La prima riga deve essere l’intestazione. Colonne: name (obbligatorio), email, locale e token (opzionali). Usa virgola o punto e virgola come separatore.', 'Η πρώτη γραμμή πρέπει να είναι η κεφαλίδα. Στήλες: name (υποχρεωτικό), email, locale και token (προαιρετικά). Χρησιμοποιήστε κόμμα ή ερωτηματικό ως διαχωριστικό.', 'Die erste Zeile muss die Kopfzeile sein. Spalten: name (Pflicht), email, locale und token (optional). Trennzeichen: Komma oder Semikolon.'],
    ...
    ['Invitation and RSVP emails are sent in this language, regardless of the site language.', 'Le email di invito e RSVP vengono inviate in questa lingua, indipendentemente dalla lingua del sito.', 'Τα email πρόσκλησης και RSVP αποστέλλονται σε αυτή τη γλώσσα, ανεξάρτητα από τη γλώσσα του site.', 'Einladungs- und RSVP-E-Mails werden in dieser Sprache versendet, unabhängig von der Website-Sprache.'],
    ['Invitation email could not be sent.', 'Impossibile inviare l’email di invito.', 'Δεν ήταν δυνατή η αποστολή email πρόσκλησης.', 'Einladungs-E-Mail konnte nicht gesendet werden.'],
    ['Invitation email sent to :email.', 'Email di invito inviata a :email.', 'Η πρόσκληση στάλθηκε στο :email.', 'Einladungs-E-Mail an :email gesendet.'],
    ...
    ['Moments from the day.', 'Momenti della giornata.', 'Στιγμές της ημέρας.', 'Momente des Tages.'],
    ...
    ['Send invitation email', 'Invia email di invito', 'Αποστολή email πρόσκλησης', 'Einladungs-E-Mail senden'],
    ['Send response', 'Invia risposta', 'Αποστολή απάντησης', 'Antwort senden'],
    ['Share your photos from the day.', 'Condividi le foto della giornata.', 'Μοιραστείτε φωτογραφίες της ημέρας.', 'Teilen Sie Fotos vom Tag.'],
    ...
    ['Up to :count images at once — JPEG, PNG, WebP, GIF, HEIC — max :mb MB each.', 'Fino a :count immagini alla volta — JPEG, PNG, WebP, GIF, HEIC — max :mb MB ciascuna.', 'Έως :count εικόνες ταυτόχρονα — JPEG, PNG, WebP, GIF, HEIC — έως :mb MB η καθεμία.', 'Bis zu :count Bilder auf einmal — JPEG, PNG, WebP, GIF, HEIC — max. :mb MB pro Datei.'],
...
$rows[] = ['Enter :count name(s) for the other guests — one per line.', 'Inserisci :count nomi degli altri ospiti — uno per riga.', 'Εισαγάγετε :count ονόματα των άλλων καλεσμένων — ένα ανά γραμμή.', 'Geben Sie :count Namen der anderen Gäste ein — einer pro Zeile.'];
$rows[] = ['Please enter all :count name(s) of the other guests (one per line).', 'Inserisci tutti i :count nomi degli altri ospiti (uno per riga).', 'Εισαγάγετε όλα τα :count ονόματα των άλλων καλεσμένων (ένα ανά γραμμή).', 'Bitte geben Sie alle :count Namen der anderen Gäste ein (einer pro Zeile).'];
